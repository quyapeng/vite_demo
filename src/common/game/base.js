...
*可视区高度
*/
export function clientH(){
	return document.documentElement.clientHeight;	
}
/**
*可视区宽度
*/
export function clientW(){
...
*/
export function getByClass(oParent,sClass,sTag){
	var reg = null;
	var str = '';
